(* OASIS_START *)
(* DO NOT EDIT (digest: 83adf6d574fb2e395f652239cc3fda2f) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("HardCamlLlvmsim", ["src"], [])];
     lib_c = [("HardCamlLlvmsim", "src", [])];
     flags =
       [
          (["oasis_library_hardcamlllvmsim_ccopt"; "compile"],
            [

...
(* OASIS_START *)
(* DO NOT EDIT (digest: 747f25f9c9ce23666fe7e3abeaf00d45) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml-llvmsim";
          bugreports = None;
          synopsis = "HardCaml LLVM Cycle Accurate Simulator";
          description =
            Some
              [
                 OASISText.Para
                   "High speed HardCaml cycle accurate simulator using LLVM"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("hardcaml.dynlink", None);
                           FindlibPackage ("llvm", None);
                           FindlibPackage ("llvm.executionengine", None);
                           FindlibPackage ("llvm.bitreader", None);
                           FindlibPackage ("llvm.bitwriter", None);
                           FindlibPackage ("llvm.analysis", None)
                        ];
                      ...
                      bs_c_sources = ["hcgetptr_stubs.c"];
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-O2"; "-Wall"])];
                   ...
                   {
                      lib_modules =
                        ["Utils"; "Globals"; "Info"; "Compile"; "Sim"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "hardcaml-llvmsim";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the testbenchs";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "HardCamlLlvmsim";
                           FindlibPackage ("hardcaml-waveterm", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_mem.ml"});
               Executable
                 ({
                     cs_name = "test_fifo";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_fifo.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/hardcaml-llvmsim.git";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/hardcaml-llvmsim";
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "F\240\222V\233\025Y%M7\232M\004D\1697";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

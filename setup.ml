...
(* OASIS_START *)
(* DO NOT EDIT (digest: 11bbd2f158567cfb61d79207ceb3cb88) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "HardCamlLlvmsim"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "l0\n\253j\018%<\182\000!\206\026\224\251\252";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
